...
const countrySelectStyles = {
  control: (base, state) => ({
    ...
    borderColor: errors.country ? '#ef4444' : '#cccccc',
    borderRadius: "8px",
    cursor: "pointer",
    color: "#000",
    outline: "none",
    outlineOffset: "0",
    boxShadow: state.isFocused ? (errors.country ? '0 0 0 1px #ef4444' : '0 0 0 1px #000') : "none",
    "&:hover": {
      borderColor: state.isFocused ? "transparent" : (errors.country ? '#ef4444' : '#ccc'),
    },
  }),
  input: (base, state) => ({
    ...base,
    boxShadow: state.isFocused || state.isHovered ? "none" : "none !important", // <== Key fix
    outline: "none !important",   // <== Key fix
    border: "none",               // Optional, just in case
  }),
  menu: (base) => ({
    ...base,
    backgroundColor: "white",
            ...
            <div className="w-full col-span-2">
              ...
              <div className="relative">
                <select
                  ...
                  onChange={handleChange}
                  className={`w-full px-3 py-2 border rounded-lg focus:outline-hidden focus:border-black ${
                    errors.amenities ? 'border-red-500 focus:ring-red-500' : 'border-[#cccccc]'
                  } bg-white pr-8 cursor-pointer`}
                  multiple={false} // Change to true if you want multi-select
                >
                  <option value="" className="text-gray-400">Select amenities</option>
        ...
        <div className="block">
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-[#cccccc] border-dashed rounded-md">
                <div className="space-y-1 text-center">
